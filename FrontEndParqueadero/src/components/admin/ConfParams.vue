<template>
  <div class="conf-params">
    <div class="content">
      <div class="field" v-if="configurado">
        <div class="control">
          <h1 class="title">
            La Copropiedad ya tiene sus parametros configurados, si necesita
            hacer cambios, dirijase al menú de modificar parámetros
          </h1>
        </div>
      </div>
...
export default {
  ...
  methods: {
    loadParams() {
      var id_coprop = this.$session.get("id_coprop");
      var url = jsonInfo.url_server + jsonInfo.name_app + "/globals/select.php";
      var requestObject = {
        tabla: "configuraciones",
        id_copropiedad: id_coprop,
      };
      this.$axios
        .get(url, { params: requestObject })
        .then((response) => {
          if (response.data.length > 0) this.configurado = true;
        })
        .catch((e) => {
          console.log(e);
          this.error = true;
